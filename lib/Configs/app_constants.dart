...
final mecDeepGreen = new Color(0xFF01826b);
final mecLightGreen = new Color(0xFF02ac88);
final mecgreen = new Color(0xFF098b74);
...
// final mecBlack = new Color(0xFF353f58);
// final mecBlue = new Color(0xFF3d9df5);
// final mecDeepGreen = new Color(0xFF296ac6);
// final mecLightGreen = new Color(0xFF036eff);
// final mecgreen = new Color(0xFF06a2ff);
// final mecteagreen = Color(0xFFeefcf8);
// final mecWhite = Colors.white;
// final mecGrey = Colors.grey;
// final mecChatbackground = new Color(0xffdde6ea);
