...
class SearchChatsState extends State<SearchChats> {
  ...
  List<dynamic> _users = List.from(<dynamic>[]);
  ...
  _chats(Map<String?, Map<String, dynamic>?> _userData,
    ...
    List<dynamic> filtered = List.from(<dynamic>[]);
                        ...
                        return StreamBuilder(
                            ...
                            builder: (context, snapshot) {
                              if (_filter.text.isNotEmpty || snapshot.hasData) {
                                if (IsShowUserFullNameAsSavedInYourContacts ==
                                    false) {
                                  filtered = availableContacts.storedUserDoc
                                      .where((user) {
